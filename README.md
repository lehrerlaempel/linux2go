...
v 0.1 | Stand: Oktober 2021 | Lizenz: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.de)
...
Nun stecken wir den zweiten USB-Stick in den Computer, auf den wir unser Linux instalieren wollen und klicken auf das DesktopIcon mit dem Namen "Install Linux Mint".
